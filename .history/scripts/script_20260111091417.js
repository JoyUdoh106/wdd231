...
const totalCreditDisplay = document.querySelector('#total-Credits');

// 1. Course Array
const courses = [
    { subject: 'CSE', number: 110, title: 'Intro to Programming', credits: 2, certificate: 'Web and Computer Programming', completed: true },
...
// 3. Function to display courses
function displayCourses(filteredCourses) {
    courseContainer.innerHTML = ""; // Clear current view
